        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
              Join our exclusive job portal and get access to premium career opportunities. 
              Enroll in our program, complete assessments, and land your ideal job.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We provide a comprehensive solution for job seekers with premium features 
              and personalized support throughout your career journey.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <CardDescription>
                  Complete technical assessments and coding challenges 
                  to showcase your abilities to potential employers.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <CardDescription>
                  Get dedicated support throughout your application process 
